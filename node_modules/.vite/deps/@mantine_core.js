...
import { a as _objectWithoutPropertiesLoose, o as _extends, t as ReactRemoveScroll } from "./Combination-ChINjbht.js";
...
//#endregion
//#region node_modules/@mantine/hooks/esm/use-callback-ref/use-callback-ref.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/core/MantineProvider/convert-css-variables/wrap-with-selector.mjs
...
function convertCssVariables(input, selector) {
	...
	return `${shared}${dark ? selector === ":host" ? wrapWithSelector(`${selector}([data-mantine-color-scheme="dark"])`, dark) : wrapWithSelector(`${selector}[data-mantine-color-scheme="dark"]`, dark) : ""}${light ? selector === ":host" ? wrapWithSelector(`${selector}([data-mantine-color-scheme="light"])`, light) : wrapWithSelector(`${selector}[data-mantine-color-scheme="light"]`, light) : ""}`;
}
//#endregion
...
//#endregion
//#region node_modules/@mantine/core/esm/core/MantineProvider/suppress-nextjs-warning.mjs
...
var defaultProps$184 = {
	transitionDuration: 200,
	transitionTimingFunction: "ease",
	animateOpacity: true
};
var Collapse = factory((props, ref) => {
	const { children, in: opened, transitionDuration, transitionTimingFunction, style, onTransitionEnd, animateOpacity, ...others } = useProps("Collapse", defaultProps$184, props);
	const theme = useMantineTheme();
...
var defaultProps$183 = {
	scrollHideDelay: 1e3,
	type: "hover"
};
var ScrollAreaRoot = (0, import_react.forwardRef)((_props, ref) => {
	const { type, scrollHideDelay, scrollbars, ...others } = useProps("ScrollAreaRoot", defaultProps$183, _props);
...
var ScrollAreaViewport = (0, import_react.forwardRef)(({ children, style, ...others }, ref) => {
	const ctx = useScrollAreaContext();
...
var defaultProps$182 = {
	scrollHideDelay: 1e3,
	type: "hover",
	scrollbars: "xy"
};
var varsResolver$89 = createVarsResolver((_, { scrollbarSize, overscrollBehavior }) => ({ root: {
	"--scrollarea-scrollbar-size": rem(scrollbarSize),
	"--scrollarea-over-scroll-behavior": overscrollBehavior
} }));
var ScrollArea = factory((_props, ref) => {
	const props = useProps("ScrollArea", defaultProps$182, _props);
...
var ScrollAreaAutosize = factory((props, ref) => {
	const { children, classNames, styles, scrollbarSize, scrollHideDelay, type, dir, offsetScrollbars, viewportRef, onScrollPositionChange, unstyled, variant, viewportProps, scrollbars, style, vars, onBottomReached, onTopReached, ...others } = useProps("ScrollAreaAutosize", defaultProps$182, props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		...others,
		ref,
		style: [{
...
var defaultProps$181 = { __staticSelector: "UnstyledButton" };
var UnstyledButton = polymorphicFactory((_props, ref) => {
	const props = useProps("UnstyledButton", defaultProps$181, _props);
...
var defaultProps$180 = {};
var VisuallyHidden = factory((_props, ref) => {
	const props = useProps("VisuallyHidden", defaultProps$180, _props);
...
var Paper = polymorphicFactory((_props, ref) => {
	const props = useProps("Paper", defaultProps$179, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Floating/get-floating-position/get-floating-position.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Floating/FloatingArrow/get-arrow-position-styles.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Floating/FloatingArrow/FloatingArrow.mjs
...
var defaultProps$178 = { zIndex: getDefaultZIndex("modal") };
...
var Overlay = polymorphicFactory((_props, ref) => {
	const props = useProps("Overlay", defaultProps$178, _props);
...
var defaultProps$177 = {};
var Portal = factory((props, ref) => {
	const { children, target, reuseTargetNode, ...others } = useProps("Portal", defaultProps$177, props);
	const [mounted, setMounted] = (0, import_react.useState)(false);
...
var defaultProps$176 = {};
var PopoverDropdown = factory((_props, ref) => {
	const props = useProps("PopoverDropdown", defaultProps$176, _props);
...
var defaultProps$175 = {
	refProp: "ref",
	popupType: "dialog"
};
var PopoverTarget = factory((props, ref) => {
	const { children, refProp, popupType, ...others } = useProps("PopoverTarget", defaultProps$175, props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Floating/use-floating-auto-update.mjs
...
function Popover(_props) {
	const props = useProps("Popover", defaultProps$174, _props);
...
var Loader = factory((_props, ref) => {
	const props = useProps("Loader", defaultProps$173, _props);
...
var defaultProps$172 = { orientation: "horizontal" };
...
var ActionIconGroup = factory((_props, ref) => {
	const props = useProps("ActionIconGroup", defaultProps$172, _props);
	const { className, style, classNames, styles, unstyled, orientation, vars, borderWidth, variant, mod, ...others } = useProps("ActionIconGroup", defaultProps$172, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		...useStyles({
...
var ActionIconGroupSection = factory((_props, ref) => {
	const props = useProps("ActionIconGroupSection", defaultProps$171, _props);
	const { className, style, classNames, styles, unstyled, vars, variant, gradient, radius, autoContrast, ...others } = useProps("ActionIconGroupSection", defaultProps$171, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		...useStyles({
...
var ActionIcon = polymorphicFactory((_props, ref) => {
	const props = useProps("ActionIcon", defaultProps$170, _props);
...
var defaultProps$169 = { variant: "subtle" };
...
var CloseButton = polymorphicFactory((_props, ref) => {
	const props = useProps("CloseButton", defaultProps$169, _props);
...
var Group = factory((_props, ref) => {
	const props = useProps("Group", defaultProps$168, _props);
...
var defaultProps$167 = {};
var InputClearButton = factory((_props, ref) => {
	const props = useProps("InputClearButton", defaultProps$167, _props);
...
var InputDescription = factory((_props, ref) => {
	const props = useProps("InputDescription", defaultProps$166, _props);
	const { classNames, className, style, styles, unstyled, vars, size, __staticSelector, __inheritStyles = true, variant, ...others } = useProps("InputDescription", defaultProps$166, props);
...
var InputError = factory((_props, ref) => {
	const props = useProps("InputError", defaultProps$165, _props);
...
var defaultProps$164 = { labelElement: "label" };
var varsResolver$77 = createVarsResolver((_, { size }) => ({ label: {
	"--input-label-size": getFontSize(size),
	"--input-asterisk-color": void 0
} }));
var InputLabel = factory((_props, ref) => {
	const props = useProps("InputLabel", defaultProps$164, _props);
	const { classNames, className, style, styles, unstyled, vars, labelElement, size, required, htmlFor, onMouseDown, children, __staticSelector, variant, mod, ...others } = useProps("InputLabel", defaultProps$164, props);
	const _getStyles = useStyles({
		name: ["InputWrapper", __staticSelector],
		props,
		classes: classes$75,
...
var defaultProps$163 = {};
var InputPlaceholder = factory((_props, ref) => {
	const props = useProps("InputPlaceholder", defaultProps$163, _props);
	const { classNames, className, style, styles, unstyled, vars, __staticSelector, variant, error, mod, ...others } = useProps("InputPlaceholder", defaultProps$163, props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		...useStyles({
...
var InputWrapper = factory((_props, ref) => {
	const props = useProps("InputWrapper", defaultProps$162, _props);
...
var Input = polymorphicFactory((_props, ref) => {
	const props = useProps("Input", defaultProps$161, _props);
...
var defaultProps$160 = {
	__staticSelector: "InputBase",
	withAria: true
};
var InputBase = polymorphicFactory((props, ref) => {
	const { inputProps, wrapperProps, ...others } = useInputProps("InputBase", defaultProps$160, props);
...
var defaultProps$159 = {};
var Flex = polymorphicFactory((_props, ref) => {
	const props = useProps("Flex", defaultProps$159, _props);
...
var FloatingIndicator = factory((_props, ref) => {
	const props = useProps("FloatingIndicator", defaultProps$158, _props);
...
var defaultProps$157 = {};
var AccordionControl = factory((props, ref) => {
	const { classNames, className, style, styles, vars, chevron, icon, onClick, onKeyDown, children, disabled, mod, ...others } = useProps("AccordionControl", defaultProps$157, props);
...
var defaultProps$156 = {};
var AccordionItem = factory((props, ref) => {
	const { classNames, className, style, styles, vars, value, mod, ...others } = useProps("AccordionItem", defaultProps$156, props);
	const ctx = useAccordionContext();
...
var defaultProps$155 = {};
var AccordionPanel = factory((props, ref) => {
	const { classNames, className, style, styles, vars, children, ...others } = useProps("AccordionPanel", defaultProps$155, props);
	const { value } = useAccordionItemContext();
	const ctx = useAccordionContext();
...
function Accordion(_props) {
	const props = useProps("Accordion", defaultProps$154, _props);
...
var Affix = factory((_props, ref) => {
	const props = useProps("Affix", defaultProps$153, _props);
...
var Alert = factory((_props, ref) => {
	const props = useProps("Alert", defaultProps$152, _props);
...
var defaultProps$151 = { inherit: false };
...
var Text = polymorphicFactory((_props, ref) => {
	const props = useProps("Text", defaultProps$151, _props);
...
var defaultProps$150 = { underline: "hover" };
var Anchor = polymorphicFactory((props, ref) => {
	const { underline, className, unstyled, mod, ...others } = useProps("Anchor", defaultProps$150, props);
...
var AngleSlider = factory((_props, ref) => {
	const props = useProps("AngleSlider", defaultProps$149, _props);
...
var defaultProps$148 = {};
var AppShellAside = factory((_props, ref) => {
	const { classNames, className, style, styles, unstyled, vars, withBorder, zIndex, mod, ...others } = useProps("AppShellAside", defaultProps$148, _props);
...
var defaultProps$147 = {};
var AppShellFooter = factory((_props, ref) => {
	const { classNames, className, style, styles, unstyled, vars, withBorder, zIndex, mod, ...others } = useProps("AppShellFooter", defaultProps$147, _props);
	const ctx = useAppShellContext();
	if (ctx.disabled) return null;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		component: "footer",
...
var defaultProps$146 = {};
var AppShellHeader = factory((_props, ref) => {
	const { classNames, className, style, styles, unstyled, vars, withBorder, zIndex, mod, ...others } = useProps("AppShellHeader", defaultProps$146, _props);
	const ctx = useAppShellContext();
	if (ctx.disabled) return null;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		component: "header",
...
var defaultProps$145 = {};
var AppShellMain = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, ...others } = useProps("AppShellMain", defaultProps$145, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		component: "main",
		ref,
...
var defaultProps$144 = {};
var AppShellNavbar = factory((_props, ref) => {
	const { classNames, className, style, styles, unstyled, vars, withBorder, zIndex, mod, ...others } = useProps("AppShellNavbar", defaultProps$144, _props);
	const ctx = useAppShellContext();
	if (ctx.disabled) return null;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		component: "nav",
...
var defaultProps$143 = {};
var AppShellSection = polymorphicFactory((_props, ref) => {
	const { classNames, className, style, styles, vars, grow, mod, ...others } = useProps("AppShellSection", defaultProps$143, _props);
	const ctx = useAppShellContext();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		ref,
		mod: [{ grow }, mod],
...
var AppShell = factory((_props, ref) => {
	const props = useProps("AppShell", defaultProps$142, _props);
...
var defaultProps$140 = { error: null };
...
var ComboboxChevron = factory((_props, ref) => {
	const props = useProps("ComboboxChevron", defaultProps$140, _props);
...
var defaultProps$139 = {};
var ComboboxDropdown = factory((props, ref) => {
	const { classNames, styles, className, style, hidden, ...others } = useProps("ComboboxDropdown", defaultProps$139, props);
...
var defaultProps$138 = { refProp: "ref" };
var ComboboxDropdownTarget = factory((props, ref) => {
	const { children, refProp } = useProps("ComboboxDropdownTarget", defaultProps$138, props);
	useComboboxContext();
...
var defaultProps$137 = {};
var ComboboxEmpty = factory((props, ref) => {
	const { classNames, className, style, styles, vars, ...others } = useProps("ComboboxEmpty", defaultProps$137, props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		ref,
...
var ComboboxEventsTarget = factory((props, ref) => {
	const { children, refProp, withKeyboardNavigation, withAriaAttributes, withExpandedAttribute, targetType, autoComplete, ...others } = useProps("ComboboxEventsTarget", defaultProps$136, props);
...
var defaultProps$135 = {};
var ComboboxFooter = factory((props, ref) => {
	const { classNames, className, style, styles, vars, ...others } = useProps("ComboboxFooter", defaultProps$135, props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		ref,
...
var defaultProps$134 = {};
var ComboboxGroup = factory((props, ref) => {
	const { classNames, className, style, styles, vars, children, label, ...others } = useProps("ComboboxGroup", defaultProps$134, props);
	const ctx = useComboboxContext();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Box, {
		ref,
		...ctx.getStyles("group", {
...
var defaultProps$133 = {};
var ComboboxHeader = factory((props, ref) => {
	const { classNames, className, style, styles, vars, ...others } = useProps("ComboboxHeader", defaultProps$133, props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		ref,
...
var ComboboxOption = factory((_props, ref) => {
	const props = useProps("ComboboxOption", defaultProps$132, _props);
...
var ComboboxOptions = factory((_props, ref) => {
	const { classNames, className, style, styles, id, onMouseDown, labelledBy, ...others } = useProps("ComboboxOptions", defaultProps$131, _props);
	const ctx = useComboboxContext();
	const _id = useId$3(id);
	(0, import_react.useEffect)(() => {
...
var ComboboxSearch = factory((_props, ref) => {
	const { classNames, styles, unstyled, vars, withAriaAttributes, onKeyDown, withKeyboardNavigation, size, ...others } = useProps("ComboboxSearch", defaultProps$130, _props);
	const ctx = useComboboxContext();
...
var ComboboxTarget = factory((props, ref) => {
	const { children, refProp, withKeyboardNavigation, withAriaAttributes, withExpandedAttribute, targetType, autoComplete, ...others } = useProps("ComboboxTarget", defaultProps$129, props);
...
function useCombobox({ defaultOpened, opened, onOpenedChange, onDropdownClose, onDropdownOpen, loop = true, scrollBehavior = "instant" } = {}) {
	...
	const clickSelectedOption = (0, import_react.useCallback)(() => {
		(document.querySelectorAll(`#${listId.current} [data-combobox-option]`)?.[selectedOptionIndex.current])?.click();
	}, []);
...
function Combobox(_props) {
	const props = useProps("Combobox", defaultProps$128, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/InlineInput/InlineInput.module.css.mjs
var classes$63 = {
	"root": "m_5f75b09e",
	"body": "m_5f6e695e",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/InlineInput/InlineInput.mjs
var InlineInputClasses = classes$63;
var InlineInput = (0, import_react.forwardRef)(({ __staticSelector, __stylesApiProps, className, classNames, styles, unstyled, children, label, description, id, disabled, error, size, labelPosition = "left", bodyElement = "div", labelElement = "label", variant, style, vars, mod, ...others }, ref) => {
	const getStyles = useStyles({
		name: __staticSelector,
...
CheckboxCard.classes = classes$62;
//#endregion
//#region node_modules/@mantine/core/esm/components/InputsGroupFieldset/InputsGroupFieldset.mjs
...
var CheckboxGroup = factory((props, ref) => {
	const { value, defaultValue, onChange, size, wrapperProps, children, readOnly, ...others } = useProps("CheckboxGroup", defaultProps$126, props);
	const [_value, setValue] = useUncontrolled({
		value,
		defaultValue,
		finalValue: [],
...
var defaultProps$125 = { icon: CheckboxIcon };
...
var CheckboxIndicator = factory((_props, ref) => {
	const props = useProps("CheckboxIndicator", defaultProps$125, _props);
...
CheckboxIndicator.classes = classes$61;
//#endregion
...
var Checkbox = factory((_props, forwardedRef) => {
	const props = useProps("Checkbox", defaultProps$124, _props);
	const { classNames, className, style, styles, unstyled, vars, color, label, id, size, radius, wrapperProps, checked, labelPosition, description, error, disabled, variant, indeterminate, icon, rootRef, iconColor, onChange, autoContrast, mod, ...others } = props;
	const ctx = useCheckboxGroupContext();
...
function Option({ data, withCheckIcon, value, checkIconPosition, unstyled, renderOption }) {
	if (!isOptionsGroup(data)) {
		...
		const check = withCheckIcon && checked && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckIcon, { className: classes$64.optionsDropdownCheckIcon });
...
var Autocomplete = factory((_props, ref) => {
	const props = useProps("Autocomplete", defaultProps$123, _props);
...
var AvatarGroup = factory((_props, ref) => {
	const props = useProps("AvatarGroup", defaultProps$122, _props);
...
var Avatar = polymorphicFactory((_props, ref) => {
	const props = useProps("Avatar", defaultProps$121, _props);
...
var BackgroundImage = polymorphicFactory((_props, ref) => {
	const props = useProps("BackgroundImage", defaultProps$120, _props);
...
var varsResolver$58 = createVarsResolver((theme, { radius, color, gradient, variant, size, autoContrast }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
		gradient,
...
var Badge = polymorphicFactory((_props, ref) => {
	const props = useProps("Badge", defaultProps$119, _props);
...
var defaultProps$118 = { iconSize: 48 };
...
var Blockquote = factory((_props, ref) => {
	const props = useProps("Blockquote", defaultProps$118, _props);
...
var defaultProps$117 = { separator: "/" };
...
var Breadcrumbs = factory((_props, ref) => {
	const props = useProps("Breadcrumbs", defaultProps$117, _props);
...
var Burger = factory((_props, ref) => {
	const props = useProps("Burger", defaultProps$116, _props);
...
var defaultProps$115 = { orientation: "horizontal" };
...
var ButtonGroup = factory((_props, ref) => {
	const props = useProps("ButtonGroup", defaultProps$115, _props);
	const { className, style, classNames, styles, unstyled, orientation, vars, borderWidth, variant, mod, ...others } = useProps("ButtonGroup", defaultProps$115, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		...useStyles({
			name: "ButtonGroup",
			props,
...
var ButtonGroupSection = factory((_props, ref) => {
	const props = useProps("ButtonGroupSection", defaultProps$114, _props);
	const { className, style, classNames, styles, unstyled, vars, variant, gradient, radius, autoContrast, ...others } = useProps("ButtonGroupSection", defaultProps$114, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		...useStyles({
...
var Button = polymorphicFactory((_props, ref) => {
	const props = useProps("Button", defaultProps$113, _props);
...
var CardSection = polymorphicFactory((_props, ref) => {
	const { classNames, className, style, styles, vars, withBorder, inheritPadding, mod, ...others } = useProps("CardSection", defaultProps$112, _props);
...
var Card = polymorphicFactory((_props, ref) => {
	const props = useProps("Card", defaultProps$111, _props);
...
var Center = polymorphicFactory((_props, ref) => {
	const props = useProps("Center", defaultProps$110, _props);
...
function ChipGroup(props) {
	const { value, defaultValue, onChange, multiple, children } = useProps("ChipGroup", defaultProps$109, props);
	const [_value, setValue] = useUncontrolled({
		value,
		defaultValue,
		finalValue: multiple ? [] : null,
...
var defaultProps$108 = { type: "checkbox" };
...
var Chip = factory((_props, ref) => {
	const props = useProps("Chip", defaultProps$108, _props);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Box, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
			...
			children: [_checked && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				children: icon || /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckIcon, { ...getStyles("checkIcon") })
...
var Code = factory((_props, ref) => {
	const props = useProps("Code", defaultProps$107, _props);
...
var defaultProps$106 = { withShadow: true };
...
var ColorSwatch = polymorphicFactory((_props, ref) => {
	const props = useProps("ColorSwatch", defaultProps$106, _props);
	const { classNames, className, style, styles, unstyled, vars, color, size, radius, withShadow, children, variant, ...others } = useProps("ColorSwatch", defaultProps$106, props);
	const getStyles = useStyles({
		name: "ColorSwatch",
		props,
		classes: classes$48,
...
var ColorSlider = factory((_props, ref) => {
	const props = useProps("ColorSlider", defaultProps$105, _props);
...
var AlphaSlider = (0, import_react.forwardRef)((props, ref) => {
	const { value, onChange, onChangeEnd, color, ...others } = useProps("AlphaSlider", defaultProps$104, props);
...
var Swatches = (0, import_react.forwardRef)(({ className, datatype, setValue, onChangeEnd, size, focusable, data, swatchesPerRow, ...others }, ref) => {
...
var ColorPicker = factory((_props, ref) => {
	const props = useProps("ColorPicker", defaultProps$103, _props);
	...
	const formatRef = (0, import_react.useRef)(format);
...
var ColorInput = factory((_props, ref) => {
	const props = useProps("ColorInput", defaultProps$102, _props);
	const { classNames, styles, unstyled, disallowInput, fixOnBlur, popoverProps, withPreview, withEyeDropper, eyeDropperIcon, closeOnColorSwatchClick, eyeDropperButtonProps, value, defaultValue, onChange, onChangeEnd, onClick, onFocus, onBlur, inputProps, format, wrapperProps, readOnly, withPicker, swatches, disabled, leftSection, rightSection, swatchesPerRow, ...others } = useInputProps("ColorInput", defaultProps$102, _props);
	const getStyles = useStyles({
		name: "ColorInput",
		props,
		classes: classes$46,
...
var Container = factory((_props, ref) => {
	const props = useProps("Container", defaultProps$101, _props);
...
var defaultProps$100 = { timeout: 1e3 };
function CopyButton(props) {
	const { children, timeout, value, ...others } = useProps("CopyButton", defaultProps$100, props);
...
var Dialog = factory((_props, ref) => {
	const props = useProps("Dialog", defaultProps$99, _props);
...
var defaultProps$98 = { orientation: "horizontal" };
...
var Divider = factory((_props, ref) => {
	const props = useProps("Divider", defaultProps$98, _props);
...
var DrawerBody = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, ...others } = useProps("DrawerBody", defaultProps$97, _props);
...
var DrawerCloseButton = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, ...others } = useProps("DrawerCloseButton", defaultProps$96, _props);
...
var DrawerContent = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, children, radius, __hidden, ...others } = useProps("DrawerContent", defaultProps$95, _props);
...
var DrawerHeader = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, ...others } = useProps("DrawerHeader", defaultProps$94, _props);
...
var DrawerOverlay = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, ...others } = useProps("DrawerOverlay", defaultProps$93, _props);
...
var DrawerRoot = factory((_props, ref) => {
	const props = useProps("DrawerRoot", defaultProps$92, _props);
...
var DrawerTitle = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, ...others } = useProps("DrawerTitle", defaultProps$91, _props);
...
var Drawer = factory((_props, ref) => {
	const { title, withOverlay, overlayProps, withCloseButton, closeButtonProps, children, opened, stackId, zIndex, ...others } = useProps("Drawer", defaultProps$90, _props);
...
var defaultProps$89 = { variant: "default" };
...
var Fieldset = factory((_props, ref) => {
	const props = useProps("Fieldset", defaultProps$89, _props);
...
var defaultProps$88 = { multiple: false };
var FileButton = (0, import_react.forwardRef)((props, ref) => {
	const { onChange, children, multiple, accept, name, form, resetRef, disabled, capture, inputProps, ...others } = useProps("FileButton", defaultProps$88, props);
...
var defaultProps$87 = { valueComponent: DefaultValue };
var _FileInput = factory((_props, ref) => {
	const props = useProps("FileInput", defaultProps$87, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Floating/use-delayed-hover.mjs
...
var defaultProps$86 = { span: 12 };
var GridCol = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, span, order, offset, ...others } = useProps("GridCol", defaultProps$86, _props);
	const ctx = useGridContext();
	const responsiveClassName = useRandomClassName();
...
var Grid = factory((_props, ref) => {
	const props = useProps("Grid", defaultProps$85, _props);
...
var defaultProps$84 = { color: "yellow" };
...
var Mark = factory((_props, ref) => {
	const props = useProps("Mark", defaultProps$84, _props);
...
var Highlight = polymorphicFactory((props, ref) => {
	const { unstyled, children, highlight, highlightStyles, color, ...others } = useProps("Highlight", defaultProps$83, props);
...
function HoverCardDropdown(props) {
	const { children, onMouseEnter, onMouseLeave, ...others } = useProps("HoverCardDropdown", defaultProps$82, props);
...
var defaultProps$81 = { refProp: "ref" };
var HoverCardTarget = (0, import_react.forwardRef)((props, ref) => {
	const { children, refProp, eventPropsWrapperName, ...others } = useProps("HoverCardTarget", defaultProps$81, props);
	...
	const eventListeners = {
		onMouseEnter: createEventHandler(children.props.onMouseEnter, ctx.openDropdown),
		onMouseLeave: createEventHandler(children.props.onMouseLeave, ctx.closeDropdown)
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Popover.Target, {
		refProp,
		ref,
...
function HoverCard(props) {
	const { children, onOpen, onClose, openDelay, closeDelay, initiallyOpened, ...others } = useProps("HoverCard", defaultProps$80, props);
...
var Image = polymorphicFactory((_props, ref) => {
	const props = useProps("Image", defaultProps$79, _props);
...
var Indicator = factory((_props, ref) => {
	const props = useProps("Indicator", defaultProps$78, _props);
	const { classNames, className, style, styles, unstyled, vars, children, position, offset, inline, label, radius, color, withBorder, disabled, processing, zIndex, autoContrast, mod, ...others } = props;
	const getStyles = useStyles({
		name: "Indicator",
		classes: classes$37,
		props,
...
var Textarea = factory((props, ref) => {
	const { autosize, maxRows, minRows, __staticSelector, resize, ...others } = useProps("Textarea", defaultProps$77, props);
...
var JsonInput = factory((props, ref) => {
	const { value, defaultValue, onChange, formatOnBlur, validationError, serialize, deserialize, onFocus, onBlur, readOnly, error, ...others } = useProps("JsonInput", defaultProps$76, props);
	const [_value, setValue] = useUncontrolled({
		value,
		defaultValue,
		finalValue: "",
...
var defaultProps$75 = {};
var varsResolver$36 = createVarsResolver((_, { size }) => ({ root: {
	"--kbd-fz": getSize(size, "kbd-fz"),
	"--kbd-padding": getSize(size, "kbd-padding")
} }));
var Kbd = factory((_props, ref) => {
	const props = useProps("Kbd", defaultProps$75, _props);
	const { classNames, className, style, styles, unstyled, vars, ...others } = props;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		component: "kbd",
		ref,
...
var ListItem = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, icon, children, mod, ...others } = useProps("ListItem", defaultProps$74, _props);
...
var defaultProps$73 = { type: "unordered" };
...
var List = factory((_props, ref) => {
	const props = useProps("List", defaultProps$73, _props);
...
var LoadingOverlay = factory((_props, ref) => {
	const props = useProps("LoadingOverlay", defaultProps$72, _props);
...
var MenuDivider = factory((props, ref) => {
	const { classNames, className, style, styles, vars, ...others } = useProps("MenuDivider", defaultProps$71, props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		ref,
...
var MenuDropdown = factory((props, ref) => {
	const { classNames, className, style, styles, vars, onMouseEnter, onMouseLeave, onKeyDown, children, ...others } = useProps("MenuDropdown", defaultProps$70, props);
...
var MenuItem = polymorphicFactory((props, ref) => {
	const { classNames, className, style, styles, vars, color, closeMenuOnClick, leftSection, rightSection, children, disabled, "data-disabled": dataDisabled, ...others } = useProps("MenuItem", defaultProps$69, props);
	const ctx = useMenuContext();
	const theme = useMantineTheme();
	const { dir } = useDirection();
...
var MenuLabel = factory((props, ref) => {
	const { classNames, className, style, styles, vars, ...others } = useProps("MenuLabel", defaultProps$68, props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		ref,
...
var defaultProps$67 = { refProp: "ref" };
...
var ModalBody = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, ...others } = useProps("ModalBody", defaultProps$65, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ModalBaseBody, {
		ref,
...
var ModalCloseButton = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, ...others } = useProps("ModalCloseButton", defaultProps$64, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ModalBaseCloseButton, {
		ref,
...
var ModalContent = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, children, __hidden, ...others } = useProps("ModalContent", defaultProps$63, _props);
...
var ModalHeader = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, ...others } = useProps("ModalHeader", defaultProps$62, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ModalBaseHeader, {
		ref,
...
var ModalOverlay = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, ...others } = useProps("ModalOverlay", defaultProps$61, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ModalBaseOverlay, {
		ref,
...
var ModalTitle = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, ...others } = useProps("ModalTitle", defaultProps$59, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ModalBaseTitle, {
		ref,
...
var defaultProps$56 = { variant: "default" };
...
var Pill = factory((_props, ref) => {
	...
	const { classNames, className, style, styles, unstyled, vars, variant, children, withRemoveButton, onRemove, removeButtonProps, radius, size, disabled, mod, ...others } = props;
...
var defaultProps$55 = { type: "visible" };
...
var PillsInput = factory((_props, ref) => {
	const { children, onMouseDown, onClick, size, disabled, __staticSelector, error, variant, ...others } = useProps("PillsInput", defaultProps$54, _props);
...
var defaultProps$52 = { rightSectionPointerEvents: "none" };
var NativeSelect = factory((props, ref) => {
	const { data, children, size, error, rightSection, unstyled, ...others } = useProps("NativeSelect", defaultProps$52, props);
...
var defaultProps$50 = { withCloseButton: true };
...
function NumberFormatter(_props) {
	const { value, defaultValue, ...others } = useProps("NumberFormatter", defaultProps$49, _props);
...
function clampAndSanitizeInput(sanitizedValue, max, min) {
	...
	else if (parsedValue > Number.MAX_SAFE_INTEGER) return max !== void 0 ? String(max) : replaced;
	return clamp$3(parsedValue, min, max);
}
...
var defaultProps$47 = { withPadding: true };
var PaginationControl = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, active, disabled, withPadding, mod, ...others } = useProps("PaginationControl", defaultProps$47, _props);
...
var defaultProps$46 = { icon: PaginationDotsIcon };
var PaginationDots = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, icon, ...others } = useProps("PaginationDots", defaultProps$46, _props);
	const ctx = usePaginationContext();
	const Icon = icon;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		ref,
...
var Pagination = factory((_props, ref) => {
	const { withEdges, withControls, getControlProps, nextIcon, previousIcon, lastIcon, firstIcon, dotsIcon, total, gap, hideWithOnePage, withPages, ...others } = useProps("Pagination", defaultProps$44, _props);
...
var defaultProps$43 = { visibilityToggleIcon: PasswordToggleIcon };
...
var varsResolver$25 = createVarsResolver((_, { size }) => ({ root: { "--pin-input-size": getSize(size ?? defaultProps$42.size, "pin-input-size") } }));
...
var defaultProps$39 = { withAria: true };
...
var defaultProps$37 = { withBorder: true };
...
var RadioGroup = factory((props, ref) => {
	const { value, defaultValue, onChange, size, wrapperProps, children, name, readOnly, ...others } = useProps("RadioGroup", defaultProps$36, props);
...
var defaultProps$35 = { icon: RadioIcon };
...
var defaultProps$34 = { labelPosition: "right" };
...
var Radio = factory((_props, ref) => {
	...
	const { classNames, className, style, styles, unstyled, vars, id, size, label, labelPosition, description, error, radius, color, variant, disabled, wrapperProps, icon: Icon = RadioIcon, rootRef, iconColor, onChange, mod, ...others } = props;
	const getStyles = useStyles({
		name: "Radio",
		classes: classes$20,
		props,
...
var varsResolver$18 = createVarsResolver((theme, { radius, color }) => ({ tooltip: {
	"--tooltip-radius": radius === void 0 ? void 0 : getRadius(radius),
	"--tooltip-bg": color ? getThemeColor(color, theme) : void 0,
	"--tooltip-color": color ? "var(--mantine-color-white)" : void 0
} }));
var Tooltip = factory((_props, ref) => {
	...
	const { children, position, refProp, label, openDelay, closeDelay, onPositionChange, opened, defaultOpened, withinPortal, radius, color, classNames, styles, unstyled, style, className, withArrow, arrowSize, arrowOffset, arrowRadius, arrowPosition, offset, transitionProps, multiline, events, zIndex, disabled, positionDependencies, onClick, onMouseEnter, onMouseLeave, inline, variant, keepMounted, vars, portalProps, mod, floatingStrategy, middlewares, ...others } = useProps("Tooltip", defaultProps$30, props);
	const { dir } = useDirection();
	const arrowRef = (0, import_react.useRef)(null);
...
var RingProgress = factory((_props, ref) => {
	...
	const { classNames, className, style, styles, unstyled, vars, label, sections, size, thickness, roundCaps, rootColor, transitionDuration, ...others } = props;
	const getStyles = useStyles({
		name: "RingProgress",
		classes: classes$17,
		props,
...
var defaultProps$28 = { withItemsBorders: true };
...
var SemiCircleProgress = factory((_props, ref) => {
	...
	const { classNames, className, style, styles, unstyled, vars, size, thickness, value, orientation, fillDirection, filledSegmentColor, emptySegmentColor, transitionDuration, label, labelPosition, ...others } = props;
	const getStyles = useStyles({
...
var RangeSlider = factory((_props, ref) => {
	...
	const setRangedValue = (val, index, triggerChangeEnd) => {
		...
		if (restrictToMarks && marks) {
			...
			clone[index] = val;
			if (index === 0) {
				if (val > clone[1] - (minRange - 1e-9)) clone[1] = Math.min(val + minRange, max);
				if (val > (max - (minRange - 1e-9) || min)) clone[index] = valueRef.current[index];
				if (clone[1] - val > maxRange) clone[1] = val + maxRange;
			}
			if (index === 1) {
				if (val < clone[0] + minRange) clone[0] = Math.max(val - minRange, min);
				if (val < clone[0] + minRange) clone[index] = valueRef.current[index];
...
var Stepper = factory((_props, ref) => {
	...
	const { classNames, className, style, styles, unstyled, vars, children, onStepClick, active, icon, completedIcon, progressIcon, color, iconSize, contentPadding, orientation, iconPosition, size, radius, allowNextStepsSelect, wrap, autoContrast, ...others } = props;
	const getStyles = useStyles({
		name: "Stepper",
		classes: classes$9,
		props,
...
var SwitchGroup = factory((props, ref) => {
	const { value, defaultValue, onChange, size, wrapperProps, children, readOnly, ...others } = useProps("SwitchGroup", defaultProps$16, props);
	const [_value, setValue] = useUncontrolled({
		value,
		defaultValue,
		finalValue: [],
...
var defaultProps$15 = { labelPosition: "right" };
...
var Switch = factory((_props, ref) => {
	...
	const { classNames, className, style, styles, unstyled, vars, color, label, offLabel, onLabel, id, size, radius, wrapperProps, thumbIcon, checked, defaultChecked, onChange, labelPosition, description, error, disabled, variant, rootRef, mod, ...others } = props;
...
var defaultProps$14 = { type: "scrollarea" };
...
var defaultProps$12 = { getControlProps: ({ data }) => ({ children: data.value }) };
...
var TextInput = factory((props, ref) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InputBase, {
		component: "input",
		ref,
		...useProps("TextInput", defaultProps$6, props),
...
var TimelineItem = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, __active, __align, __lineActive, __vars, bullet, radius, color, lineVariant, children, title, mod, ...others } = useProps("TimelineItem", defaultProps$4, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/TypographyStylesProvider/TypographyStylesProvider.module.css.mjs
var classes = { "root": "m_d6493fad" };
//#endregion
//#region node_modules/@mantine/core/esm/components/TypographyStylesProvider/TypographyStylesProvider.mjs
var defaultProps = {};
